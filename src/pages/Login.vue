  ...
  methods: {
    ...
    async login() {
      ...
      if (result.flag) {
        ...
        this.$message.success(result.data.user.username + '，欢迎回来！');
...
body {
  ...
  margin: -20px 0 50px;
  overflow: hidden;
  background-image: url("https://pic1.zhimg.com/v2-b3c2c6745b9421a13a3c4706b19223b3_r.jpg?source=1940ef5c");
...
.overlay {
  background: #54a9db;
  background: linear-gradient(to right, #4da6d9, #b9315e) no-repeat 0 0 / cover;
  color: #fff;
  position: relative;
  left: -100%;
  height: 100%;
